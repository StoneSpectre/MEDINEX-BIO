...
export default function ExplorerV2() {
  ...
  const cssVars = `
    .explorer-v2-container {
      --color-background-tertiary: #0C0E14;
      --color-background-secondary: #141820;
      --color-background-primary: #1E2330;
      --color-border-primary: #1BC99A;
      --color-border-secondary: #2E7D6E;
      --color-border-tertiary: #1E2330;
